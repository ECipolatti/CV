...
\vspace{.5cm}
\begin{subtitle}
Dorrego 4750, Santa Fe, Argentina\, \SubBulletSymbol\, 27 years old
\par
...
\hspace{14.5cm}\smash{\includegraphics[width=3.5cm]{photo.png}}
\begin{body}
...
\begin{detail}
	...
	\SubBulletItem
	Approved courses: 40 \SubBulletSymbol\, Progress: 92\%.


\end{detail}
\BulletItem	Thesis: Development of a library for multidimentional domains coupling for OpenFOAM with application on nuclear technology.
\begin{detail}
	\SubBulletItem
	Goal: design and build a library for multidimentional domains coupling for OpenFOAM that is capable of reduce the computational cost in large CFD problems, where some parts of it are not revelant or don't require as much precision. The library will be implemented on a PHWR nuclear reactor.
...
\begin{detail}
	\SubBulletItem
	Bachelor Degree: ``Economía y Gestión de las Organizaciones''.
...
\BulletItem
Other languages: Java \SubBulletSymbol\, Python \SubBulletSymbol\, SQL \SubBulletSymbol\, HTML \SubBulletSymbol\, CSS

\textbf{Others skills}
\BulletItem Agile software development mothods.
\BulletItem Leadership \SubBulletSymbol\, Proactivity \SubBulletSymbol\, Teamwork skills.
...
\BulletItem
\href{https://www.linkedin.com/in/edgardocipolatti/}{https://www.linkedin.com/in/edgardocipolatti/}
...
Neural Network, Network Infrastructure, Computer Hardware, Agile software development methods.
